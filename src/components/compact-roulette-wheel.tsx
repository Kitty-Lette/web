      ...
      <div className="relative rounded-2xl p-9 overflow-hidden">
        ...
        <div className="relative z-10 w-full bg-white rounded-xl border-2 border-gray-100 mb-5 shadow-inner ">
          {isSpinning ? (
            <div className="flex justify-center">
              <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 w-full max-w-xs">
                ...
                <div className="p-3 space-y-2">
                  {/* NFT Name */}
                  <h3 className="text-base font-bold text-gray-900 animate-pulse">
            ...
            <div className="flex justify-center">
              <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 w-full max-w-xs">
                {/* NFT Image */}
              ...
              <ConnectButton.Custom>
                {({ openConnectModal }) => (
                  <Button 
                    ...
                    className="cursor-pointer relative overflow-hidden bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 hover:from-gray-800 hover:via-gray-700 hover:to-gray-800 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 border border-gray-600/30"
                  >
